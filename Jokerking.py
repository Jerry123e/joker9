...
\033[1;92m                                               
\033[1;97m-----------------------------------------------
\033[1;91m➣ OWNER : JOKER
\033[1;91m➣ JOKER : BUR D4D
\033[1;91m➣ Whatsapp : 03114952549
\033[1;97m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def men():
	...
	if rana =="":
	    ...
	    os.system('clear')
	    devil('[!] Please Wait While Page Is Loding.')
	    devil('CKG-10%...')
	    devil('CKG-20%...')
	    devil('CKG-50%...')
	    devil('CKG-70%...')
		...
		os.system('clear')
		print banner
		devil('[✓] Please Wait While Tool Is Updating')
		os.system('git pull origin master')
		devil('[✓] Tool Has Been Update Successfully')
		devil('[✓] Please Wait While Update Is Setting Up On Your Mobile Phone')
		time.sleep(3)
		os.devil('python2 Devil.py')
	elif rana =="6":
		os.system('xdg-open https://www.facebook.com/itz.devil302')
		menu()
	elif rana =="7":
		os.system('rm -rf login.txt')
		devil('[✓] Logged Out Successfully')
		os.system('python2 Devil.py')
	else:
		print "[!] Wrong Input"
		men()
...
def crack_menu():
	...
	if crm =="":
		...
		try:
			...
			devil('\033[1;97m[✓] Account Name \033[1;97m:\033[1;97m '+op['name'])
		except KeyError:
			print"[!] ID Not Found!"
			raw_input("\nPress Enter To Back  ")
			crack()
        ...
        devil('[✓] Total Friends: '+str(len(id)))
        time.sleep(0.5)
	devil('[✓] The Process Has Been Started.')
	time.sleep(0.5)
        devil('[!] To Stop Process Press CTRL Then Z')
        time.sleep(0.5)
        print (47*"-")
	...
	p.map(main, id)
	print "\033[1;97m----------------------------------------------"
	devil('[✓] Process Has Been Completed.')
	devil('\033[1;97m[✓] Checkpoint IDS Has Been Saved.')
	xx = str(len(oks))
...
def idfromfriend():
	...
	try:
		...
		z=json.loads(r.text)
		devil('[✓] Getting Friends Numeric IDs...')
		print"--------------------------------------"
...
def accept():
	...
	if '[]' in str(teman['data']):
		...
		raw_input("Press Enter To Back ")
		bot()
	devil('[✓] The Process Has Been Start')
	print (40*"-")
	for i in teman['data']:
